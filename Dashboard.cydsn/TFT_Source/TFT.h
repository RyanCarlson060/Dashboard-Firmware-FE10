...
#define CYGRAPHICS_WRITE(addr, data)        TFT_Write8(addr, data)
#define CYGRAPHICS_READ(addr)               TFT_Read8(addr)
#define CYGRAPHICS_WRITEM(addr, data, num)  TFT_WriteM8(addr, data, num)
...
#define TFT_READ_HIGH_PULSE          (11u - 1u)
