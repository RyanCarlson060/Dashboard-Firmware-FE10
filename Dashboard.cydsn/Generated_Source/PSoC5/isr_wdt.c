...
void isr_wdt_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_wdt__INTC_NUMBER] = address;
}
...
cyisraddress isr_wdt_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)isr_wdt__INTC_NUMBER];
}
