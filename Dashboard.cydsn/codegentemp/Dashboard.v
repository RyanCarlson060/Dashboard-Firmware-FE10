...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("fe15690b-ce9c-40fb-adfc-d80f32ce76c9/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("fe15690b-ce9c-40fb-adfc-d80f32ce76c9/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__GLV_V_net;
	wire [0:0] tmpFB_0__GLV_V_net;
	wire [0:0] tmpIO_0__GLV_V_net;
	wire [0:0] tmpINTERRUPT_0__GLV_V_net;
	electrical [0:0] tmpSIOVREF__GLV_V_net;
	...
	cy_psoc3_pins_v1_10
		...
		GLV_V
		 (.oe(tmpOE__GLV_V_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GLV_V_net[0:0]}),
		  .analog({Net_307}),
		  .io({tmpIO_0__GLV_V_net[0:0]}),
		  .siovref(tmpSIOVREF__GLV_V_net),
		  .interrupt({tmpINTERRUPT_0__GLV_V_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GLV_V_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_DelSig_v3_30_1 ADC_GLV_V (
        .aclk(1'b0),
        .eoc(Net_310),
        .mi(1'b0),
        .nVref(Net_312),
    ...
    Timer_v2_80_2 ReadyToDrive_Timer (
        .capture(1'b0),
        .capture_out(Net_510),
        .clock(Net_899),
        .enable(1'b1),
