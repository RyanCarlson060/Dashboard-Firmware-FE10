...
module top ;
    ...
    defparam DriveGND.port_names = "T1, T2";
    defparam DriveGND.width = 2;
    ...
    defparam HVGND.port_names = "T1, T2";
    defparam HVGND.width = 2;
	...
	wire [0:0] tmpOE__HV_net;
	wire [0:0] tmpFB_0__HV_net;
	wire [0:0] tmpIO_0__HV_net;
	wire [0:0] tmpINTERRUPT_0__HV_net;
	electrical [0:0] tmpSIOVREF__HV_net;
	...
	assign tmpOE__HV_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Drive_net;
	wire [0:0] tmpFB_0__Drive_net;
	wire [0:0] tmpIO_0__Drive_net;
	wire [0:0] tmpINTERRUPT_0__Drive_net;
	electrical [0:0] tmpSIOVREF__Drive_net;
	...
	assign tmpOE__Drive_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RGB3_1_net;
	wire [0:0] tmpFB_0__RGB3_1_net;
	wire [0:0] tmpIO_0__RGB3_1_net;
	wire [0:0] tmpINTERRUPT_0__RGB3_1_net;
	electrical [0:0] tmpSIOVREF__RGB3_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e7eb8a27-81f5-489d-b6a7-95d193398d80"),
		  ...
		  .input_buffer_sel(2'b00))
		RGB3_1
		 (.oe(tmpOE__RGB3_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RGB3_1_net[0:0]}),
		  .io({tmpIO_0__RGB3_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RGB3_1_net),
		  .interrupt({tmpINTERRUPT_0__RGB3_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RGB3_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RGB2_1_net;
	wire [0:0] tmpFB_0__RGB2_1_net;
	wire [0:0] tmpIO_0__RGB2_1_net;
	wire [0:0] tmpINTERRUPT_0__RGB2_1_net;
	electrical [0:0] tmpSIOVREF__RGB2_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6651f51b-914a-4602-8148-2b8e90c92527"),
		  ...
		  .input_buffer_sel(2'b00))
		RGB2_1
		 (.oe(tmpOE__RGB2_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RGB2_1_net[0:0]}),
		  .io({tmpIO_0__RGB2_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RGB2_1_net),
		  .interrupt({tmpINTERRUPT_0__RGB2_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RGB2_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RGB1_1_net;
	wire [0:0] tmpFB_0__RGB1_1_net;
	wire [0:0] tmpIO_0__RGB1_1_net;
	wire [0:0] tmpINTERRUPT_0__RGB1_1_net;
	electrical [0:0] tmpSIOVREF__RGB1_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("63277c7e-8aaa-4456-9cb0-be9709bb575c"),
		  ...
		  .input_buffer_sel(2'b00))
		RGB1_1
		 (.oe(tmpOE__RGB1_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RGB1_1_net[0:0]}),
		  .io({tmpIO_0__RGB1_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RGB1_1_net),
		  .interrupt({tmpINTERRUPT_0__RGB1_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RGB1_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__D_BL_net;
	wire [0:0] tmpFB_0__D_BL_net;
	wire [0:0] tmpIO_0__D_BL_net;
	wire [0:0] tmpINTERRUPT_0__D_BL_net;
	electrical [0:0] tmpSIOVREF__D_BL_net;
	...
	cy_psoc3_pins_v1_10
		...
		D_BL
		 (.oe(tmpOE__D_BL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__D_BL_net[0:0]}),
		  .io({tmpIO_0__D_BL_net[0:0]}),
		  .siovref(tmpSIOVREF__D_BL_net),
		  .interrupt({tmpINTERRUPT_0__D_BL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D_BL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__D_RST_net;
	wire [0:0] tmpFB_0__D_RST_net;
	wire [0:0] tmpIO_0__D_RST_net;
	wire [0:0] tmpINTERRUPT_0__D_RST_net;
	electrical [0:0] tmpSIOVREF__D_RST_net;
	...
	cy_psoc3_pins_v1_10
		...
		D_RST
		 (.oe(tmpOE__D_RST_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__D_RST_net[0:0]}),
		  .io({tmpIO_0__D_RST_net[0:0]}),
		  .siovref(tmpSIOVREF__D_RST_net),
		  .interrupt({tmpINTERRUPT_0__D_RST_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__D_RST_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BMS_LED_net;
	wire [0:0] tmpFB_0__BMS_LED_net;
	wire [0:0] tmpIO_0__BMS_LED_net;
	wire [0:0] tmpINTERRUPT_0__BMS_LED_net;
	electrical [0:0] tmpSIOVREF__BMS_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("56cff4a5-4c99-4c74-8ffd-c716e780564d"),
		  ...
		  .input_buffer_sel(2'b00))
		BMS_LED
		 (.oe(tmpOE__BMS_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BMS_LED_net[0:0]}),
		  .io({tmpIO_0__BMS_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__BMS_LED_net),
		  .interrupt({tmpINTERRUPT_0__BMS_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BMS_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__IMD_LED_net;
	wire [0:0] tmpFB_0__IMD_LED_net;
	wire [0:0] tmpIO_0__IMD_LED_net;
	wire [0:0] tmpINTERRUPT_0__IMD_LED_net;
	electrical [0:0] tmpSIOVREF__IMD_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ffca8d03-306b-48d0-bb85-9a96657eec8d"),
		  ...
		  .input_buffer_sel(2'b00))
		IMD_LED
		 (.oe(tmpOE__IMD_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IMD_LED_net[0:0]}),
		  .io({tmpIO_0__IMD_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__IMD_LED_net),
		  .interrupt({tmpINTERRUPT_0__IMD_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__IMD_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_80_1 ReadyToDrive_Timer (
        .capture(1'b0),
        .capture_out(Net_590),
        .clock(Net_899),
        .enable(1'b1),
    ...
    ADC_SAR_SEQ_P4_v2_50_2 ADC_GLV_V (
        .aclk(1'b0),
        .eoc(Net_828),
        .sdone(Net_829),
        .soc(1'b0),
	...
	wire [0:0] tmpOE__Analog_2_net;
	wire [0:0] tmpFB_0__Analog_2_net;
	wire [0:0] tmpIO_0__Analog_2_net;
	wire [0:0] tmpINTERRUPT_0__Analog_2_net;
	electrical [0:0] tmpSIOVREF__Analog_2_net;

	cy_psoc3_pins_v1_10
		#(.id("16d49838-2a5a-4591-9978-775d43616f9a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Analog_2
		 (.oe(tmpOE__Analog_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Analog_2_net[0:0]}),
		  .analog({Net_809}),
		  .io({tmpIO_0__Analog_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Analog_2_net),
		  .interrupt({tmpINTERRUPT_0__Analog_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Analog_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DISP_net;
	wire [0:0] tmpFB_0__DISP_net;
	wire [0:0] tmpIO_0__DISP_net;
	wire [0:0] tmpINTERRUPT_0__DISP_net;
	electrical [0:0] tmpSIOVREF__DISP_net;

	cy_psoc3_pins_v1_10
		#(.id("30a0c54a-caed-4f59-826a-53d06778d0b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DISP
		 (.oe(tmpOE__DISP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DISP_net[0:0]}),
		  .io({tmpIO_0__DISP_net[0:0]}),
		  .siovref(tmpSIOVREF__DISP_net),
		  .interrupt({tmpINTERRUPT_0__DISP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DISP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Digital1_net;
	wire [0:0] tmpFB_0__Digital1_net;
	wire [0:0] tmpIO_0__Digital1_net;
	wire [0:0] tmpINTERRUPT_0__Digital1_net;
	electrical [0:0] tmpSIOVREF__Digital1_net;

	cy_psoc3_pins_v1_10
		#(.id("5611b269-5d88-4029-997d-247730bbde39"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Digital1
		 (.oe(tmpOE__Digital1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Digital1_net[0:0]}),
		  .io({tmpIO_0__Digital1_net[0:0]}),
		  .siovref(tmpSIOVREF__Digital1_net),
		  .interrupt({tmpINTERRUPT_0__Digital1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Digital1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Digital2_net;
	wire [0:0] tmpFB_0__Digital2_net;
	wire [0:0] tmpIO_0__Digital2_net;
	wire [0:0] tmpINTERRUPT_0__Digital2_net;
	electrical [0:0] tmpSIOVREF__Digital2_net;

	cy_psoc3_pins_v1_10
		#(.id("8d63ce97-efea-48bb-92fc-5f96a0ce25ea"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Digital2
		 (.oe(tmpOE__Digital2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Digital2_net[0:0]}),
		  .io({tmpIO_0__Digital2_net[0:0]}),
		  .siovref(tmpSIOVREF__Digital2_net),
		  .interrupt({tmpINTERRUPT_0__Digital2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Digital2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Digital3_net;
	wire [0:0] tmpFB_0__Digital3_net;
	wire [0:0] tmpIO_0__Digital3_net;
	wire [0:0] tmpINTERRUPT_0__Digital3_net;
	electrical [0:0] tmpSIOVREF__Digital3_net;

	cy_psoc3_pins_v1_10
		#(.id("28d41023-749c-46bb-adf6-68743a4d82c4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Digital3
		 (.oe(tmpOE__Digital3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Digital3_net[0:0]}),
		  .io({tmpIO_0__Digital3_net[0:0]}),
		  .siovref(tmpSIOVREF__Digital3_net),
		  .interrupt({tmpINTERRUPT_0__Digital3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Digital3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Digital4_net;
	wire [0:0] tmpFB_0__Digital4_net;
	wire [0:0] tmpIO_0__Digital4_net;
	wire [0:0] tmpINTERRUPT_0__Digital4_net;
	electrical [0:0] tmpSIOVREF__Digital4_net;

	cy_psoc3_pins_v1_10
		#(.id("98dcd150-5070-4a42-864e-d2ff1ea55937"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Digital4
		 (.oe(tmpOE__Digital4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Digital4_net[0:0]}),
		  .io({tmpIO_0__Digital4_net[0:0]}),
		  .siovref(tmpSIOVREF__Digital4_net),
		  .interrupt({tmpINTERRUPT_0__Digital4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Digital4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
