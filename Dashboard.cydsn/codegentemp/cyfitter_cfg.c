...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH0, 0x000000C0u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_SAR_MUX_SWITCH_HW_CTRL, 0x000000C0u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F305Du, /* Base address: 0x400F3000 Count: 93 */
			0x400F3140u, /* Base address: 0x400F3100 Count: 64 */
			0x400F3256u, /* Base address: 0x400F3200 Count: 86 */
			0x400F3355u, /* Base address: 0x400F3300 Count: 85 */
			0x400F400Du, /* Base address: 0x400F4000 Count: 13 */
			0x400F4130u, /* Base address: 0x400F4100 Count: 48 */
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x330033AAu);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x22222222u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0xB0B00000u);

		/* UDB_PA_1 Starting address: CYDEV_UDB_PA1_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA1_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x9CC90000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG12), 0x0000FFFFu);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT0_BASE), 0x000000FEu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x00DB6DB1u);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x000000FFu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00DB6DB6u);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT2_BASE), 0x000000C0u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT2_PC2), 0x000000C0u);

	/* IOPINS0_3 Starting address: CYDEV_GPIO_PRT3_BASE */
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00C49D80u);

	/* IOPINS0_4 Starting address: CYDEV_GPIO_PRT4_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT4_BASE), 0x00000038u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT4_PC), 0x00036C40u);

	/* IOPINS0_5 Starting address: CYDEV_GPIO_PRT5_BASE */
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC), 0x00030C00u);

	/* IOPINS0_6 Starting address: CYDEV_GPIO_PRT6_BASE */
	CY_SET_REG32((void *)(CYREG_GPIO_PRT6_PC), 0x00009000u);
