...
*/
     ...
     *  @{
     */
        #define BMS_LED_INTR_NONE      (uint16)(0x0000u)
        #define BMS_LED_INTR_RISING    (uint16)(0x0001u)
        #define BMS_LED_INTR_FALLING   (uint16)(0x0002u)
        #define BMS_LED_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define BMS_LED_INTR_MASK      (0x01u) 
#endif /* (BMS_LED__INTSTAT) */
...
/* SIO registers */
#if defined(BMS_LED__SIO_CFG)
    #define BMS_LED_SIO_HYST_EN        (* (reg8 *) BMS_LED__SIO_HYST_EN)
    #define BMS_LED_SIO_REG_HIFREQ     (* (reg8 *) BMS_LED__SIO_REG_HIFREQ)
    #define BMS_LED_SIO_CFG            (* (reg8 *) BMS_LED__SIO_CFG)
    #define BMS_LED_SIO_DIFF           (* (reg8 *) BMS_LED__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define BMS_LED_0_INTTYPE_REG 		(* (reg8 *) BMS_LED__0__INTTYPE)
#endif /* (BMS_LED__INTSTAT) */
